...
import com.cristian.design.patterns.framework.Event;
import com.cristian.design.patterns.framework.EventDispatcher;

/**
 * The {@link AbstractEvent} class serves as a base class for defining custom events happening with your system. In this example we have two
...
public abstract class AbstractEvent implements Event {
  ...
  /**
   * Returns the event type as a {@link Class} object In this example, this method is used by the {@link EventDispatcher} to dispatch events
