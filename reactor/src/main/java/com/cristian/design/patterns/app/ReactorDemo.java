...
import com.cristian.design.patterns.framework.Dispatcher;
import com.cristian.design.patterns.framework.NioDatagramChannel;
import com.cristian.design.patterns.framework.NioReactor;
import com.cristian.design.patterns.framework.NioServerSocketChannel;
import com.cristian.design.patterns.framework.ThreadPoolDispatcher;

/**
 * This application demonstrates Reactor pattern. The example demonstrated is a Distributed Logging Service where it listens on multiple TCP
 * or UDP sockets for incoming log requests.
 *
 * <p><i>INTENT</i> <br>
 * The Reactor design pattern handles service requests that are delivered concurrently to an application by one or more clients. The
 * application can register specific handlers for processing which are called by reactor on specific events.
 *
 * <p><i>PROBLEM</i> <br>
 * Server applications in a distributed system must handle multiple clients that send them service requests. Following forces need to be
 * resolved:
 * <ul>
 * <li>Availability</li>
 * <li>Efficiency</li>
